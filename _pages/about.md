...
**Contact:** Feel free to explore my website and get in touch with me for any inquiries or collaborations. I am always open to exploring interesting evolutionary topics and establishing new collaborations with researchers from around the world. Text me at: **biom€ndi-ioz_ac_cn**. To ensure that you are human and not a spam bot, please replace the Euro symbol (€) for the letter "e", the hyphen (-) with the "at" symbol (@), and the two underscores for two periods. Sorry for the inconvenience. Thanks for your interest in my work.
