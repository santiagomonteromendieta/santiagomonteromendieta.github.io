...
**Contact:** Feel free to explore my website and get in touch with me for any inquiries or collaborations. I am always open to exploring interesting evolutionary topics and establishing new collaborations with researchers from around the world. Text me at: **biom€ndi-ioz-ac-cn**. To ensure that you are human and not a spam bot, please replace the first hyphen with the at symbol and the remaining ones with period symbols. You should also replace the sign of Euro by the letter e in lowercase. Sorry for the inconvenience. Thanks for your interest in my work.
