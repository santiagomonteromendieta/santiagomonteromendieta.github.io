...
<div style="border-radius: 10px; border: 2px solid black; padding: 10px;"><b>Data access:</b> Research data (probe sequences, alignments, trees, and scripts) are available on Github: https://github.com/biomendi/OREOBATES-PHYLOGENOMICS. Raw reads in FASTQ format have been deposited at the NCBI Sequence Read Archive (SRA) under BioProject PRJNA631142</div>
