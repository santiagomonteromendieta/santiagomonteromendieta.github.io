...
In my doctoral dissertation, I delved into evolutionary genetics using state-of-the-art genomic tools. My focus extended beyond traditional model organisms to explore how species adapted to diverse altitudinal environments and the genetic underpinnings of adaptive traits in high-altitude habitats. Through the study of Eastern honey bees in China and Neotropical frogs in the Andean Mountains, my research uncovered critical insights into the core drivers of evolution, including natural selection and genetic drift. If you're interested in exploring these questions further, feel free to read my thesis, where you will find in-depth answers and analysis. 
