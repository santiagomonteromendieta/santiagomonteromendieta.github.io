...
<p>All my publications and doctoral thesis can be found below. Note that names marked with a plus sign (+) indicate co-first authorship, though the actual contribution may not be truly equal in some papers. In such cases (undisclosed to avoid potential issues), my role encompassed the majority of conceptualisation, analysis, and manuscript preparation. Happy reading! 📖</p>
