...
<p>All my publications and doctoral thesis can be found <strong>below</strong>. Names marked with a plus sign (+) indicate co-first authorship, though the actual contribution may not be truly equal in some papers. In such unfair cases (which I keep undisclosed on purpose), my role encompassed the majority of conceptualisation, analysis, and manuscript preparation. Happy reading! 📖</p>
